...
namespace GoalList.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MainPage>("Shell_Main".GetLocalized(), Symbol.Accept));
            _primaryItems.Add(ShellNavigationItem.FromType<NotesPage>("Shell_Profile".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<QuotesPage>("Shell_Quotes".GetLocalized(), Symbol.Comment));
        ...
        private void OpenPane_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationMenu.PaneForeground = (Brush)Application.Current.Resources["SystemControlForegroundBaseHighBrush"];
        }
        ...
        private void GoToState(string stateName)
        {
            switch (stateName)
            {
                ...
                case NarrowStateName:
                    ...
                    IsPaneOpen = false;
                    //NavigationMenu.PaneForeground = new SolidColorBrush(Colors.White);
                    break;
                default:
                    break;
            }
